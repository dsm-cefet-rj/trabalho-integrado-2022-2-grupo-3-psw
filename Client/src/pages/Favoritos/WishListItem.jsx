                                ...
                                <div className="col-12 mt-2">
                                    <button className="btn btn-danger" onClick={() => {
                                        ...
                                        <button className="btn btn-danger ms-4" onClick={() => {
                                            cart(user.id, item.product._id).then(alert(`${item.product.nome} removido do carrinho!`))
                                            getUser(token);
                                        }}>
                                            <BsFillCartXFill size={25} style={{ marginRight: "10px" }} />
                                            Remover do carrinho
                                        </button>
                                        }
